...
if __name__ == "__main__":
    ...
    output_evidences_path=f"test/results/evidence_arrays/test_{population}_{timestep}.tsv" #for test dataset

    output_coverage_path=f"test/results/coverage_arrays/test_{population}_{timestep}.npz" #for test dataset
